...
export const Route = createFileRoute("/_authenticated/app")({
  ...
  head: () => ({
    meta: [
      { title: "Mi espacio docente — SIED MX" },
      { name: "description", content: "Tu escritorio SIED MX: tu grupo, tus planeaciones, tus evaluaciones y tu biblioteca, solo para ti." },
      { property: "og:title", content: "Mi espacio docente — SIED MX" },
      { property: "og:description", content: "Escritorio personal del docente en SIED MX." },
...
function AppShell() {
  ...
  const nombre = perfil.nombre || "Docente";
  ...
  const showConfig = active === "config";
    ...
    <div className="min-h-screen flex bg-background text-foreground">
      ...
      <main className="flex-1 min-w-0">
        ...
        {query.trim() ? (
          ...
          <Configuracion perfil={perfil} email={email} alumnos={alumnos} onSaved={recargar} />
        ) : showAula ? (
          <>
            <DemoBanner />
